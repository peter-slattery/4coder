...
// NOTE(PS): Uncomment this line if you need to go back to default 4coder
//char *default_custom_target = "../code/custom/4coder_default_bindings.cpp";
char* default_custom_target = "../code/custom/gs/4coder_gs_custom.cpp";
